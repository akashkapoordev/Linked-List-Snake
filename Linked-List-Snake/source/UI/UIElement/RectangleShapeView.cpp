...
namespace UI
{
	namespace UIElement
	{
		...
		{
			UIView::initialize();
			setRectangleSize(rectangle_size);
			setRectanglePosition(rectangle_position);
		...
		void RectangleShapeView::setRectangleSize(sf::Vector2f rectangle_size)
		{
			rectangle_shape.setSize(rectangle_size);
		}

		void RectangleShapeView::setRectanglePosition(sf::Vector2f rectangle_position)
		{
